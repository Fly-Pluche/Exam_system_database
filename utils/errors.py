...
CompetitionNotFound = message("考试不存在", "您要找的考试不存在")
BankInfoNotFound = message("题库不存在", "当前考试未配置题库")
QuestionLogNotFound = message("考试记录不存在", "您的答题记录不存在")
CompetitionHasEnded = message("考试已经结束", "您要参与的考试已经结束")
CompetitionNotStarted = message("考试尚未开始", "您要参加的考试还没开始")
