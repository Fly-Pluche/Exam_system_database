    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind_num', models.IntegerField(default=0, help_text='考试使用次数', verbose_name='考试使用次数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='创建时间', verbose_name='创建时间')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='更新时间', verbose_name='更新时间')),
                ('kind_id', shortuuidfield.fields.ShortUUIDField(blank=True, db_index=True, editable=False, help_text='考试类别唯一标识', max_length=22, null=True)),
                ...
                ('bank_id', models.CharField(blank=True, db_index=True, help_text='题库唯一标识', max_length=32, null=True, verbose_name='题库id')),
                ('kind_type', models.IntegerField(choices=[(0, '技术类'), (1, '教育类'), (2, '文化类'), (3, '常识类'), (6, '地理类'), (7, '体育类'), (4, '面试题')], default=0, help_text='考试类型', verbose_name='考试类型')),
                ('kind_name', models.CharField(blank=True, help_text='竞赛类别名称', max_length=32, null=True, verbose_name='考试名称')),
                ...
                ('cop_startat', models.DateTimeField(default=django.utils.timezone.now, help_text='考试开始时间', verbose_name='考试开始时间')),
                ('period_time', models.IntegerField(default=60, help_text='答题时间(min)', verbose_name='答题时间')),
                ('cop_finishat', models.DateTimeField(blank=True, help_text='考试结束时间', null=True, verbose_name='考试结束时间')),
                ('total_partin_num', models.IntegerField(default=0, help_text='总参与人数', verbose_name='total_partin_num')),
            ],
            options={
                'verbose_name': '考试类别信息',
                'verbose_name_plural': '考试类别信息',
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='创建时间', verbose_name='创建时间')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='更新时间', verbose_name='更新时间')),
                ('kind_id', models.CharField(blank=True, db_index=True, help_text='考试类别唯一标识', max_length=32, null=True, verbose_name='考试id')),
