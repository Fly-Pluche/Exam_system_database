...
from business.models import (AppConfigInfo, BusinessAccountInfo,BusinessEmailInfo,
...
class BusinessEmailInfoAdmin(admin.ModelAdmin):
    """
    商家账户后台
    """
...
admin.site.register(BusinessEmailInfo,BusinessEmailInfoAdmin)
