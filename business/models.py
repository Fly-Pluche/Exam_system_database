...
class BusinessEmailInfo(CreateUpdateMixin):
    """ 企业账户 """
    # 帐户信息
    email = models.CharField(_(u'邮箱'), max_length=40, blank=True, null=True, help_text=u'邮箱', db_index=True,
                             unique=True)

    class Meta:
        verbose_name = _(u'可认证企业')
        verbose_name_plural = _(u'可认证企业')
